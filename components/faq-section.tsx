...
const faqData: FAQItem[] = [
  {
    question: "What is ZipLink and who is it for?",
    answer:
      "ZipLink is a comprehensive billing automation platform designed for businesses that need custom contract management. It's perfect for SaaS companies, service providers, and enterprises looking to streamline their billing processes.",
  },
  {
  ...
  {
    question: "Can I integrate ZipLink with my existing tools?",
    answer:
      "Yes! ZipLink integrates seamlessly with popular CRM systems, accounting software, and payment processors. We support APIs and webhooks for custom integrations with your existing workflow.",
  },
  {
  ...
  {
    question: "Is my data secure with ZipLink?",
    answer:
  ...
  {
    question: "How do I get started with ZipLink?",
    answer:
